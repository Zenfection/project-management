...
const config = {
    ...
    theme: {
        ...
        extend: {
            ...
            fontFamily: {
                sans: `"Inter var", ${_fontFamily.sans.join(",")}`,
                mono: `"IBM Plex Mono", ${_fontFamily.mono.join(",")}`,
            },
            opacity: {
                12: "0.12",
                38: "0.38",
    ...
    plugins: [
        ...
        require(resolve(__dirname, "src/@fuse/tailwind/plugins/utilities")),
        require(resolve(__dirname, "src/@fuse/tailwind/plugins/icon-size")),
        require(resolve(__dirname, "src/@fuse/tailwind/plugins/theming"))({
            themes,
        }),
