...
export class SettingAccountValidator {
  static checkName(control: AbstractControl): Observable<ValidationErrors | null> {
  ...
  static checkEmail(control: AbstractControl): Observable<ValidationErrors | null> {
  ...
  static checkPhoneNumberVN(control: AbstractControl): Observable<ValidationErrors | null> {
