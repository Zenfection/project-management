...
CREATE TABLE "Deparment" (
    ...
    CONSTRAINT "Deparment_pkey" PRIMARY KEY ("department_id")
);
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_deparmentId_fkey" FOREIGN KEY ("deparmentId") REFERENCES "Deparment"("department_id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Position" ADD CONSTRAINT "Position_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("user_id") ON DELETE SET NULL ON UPDATE CASCADE;
